"""
Django settings for trydjanog project.
...
SECRET_KEY = 'hk8tybqm%=#ctypchfl@ofm2&@+r($yj-j3ks&==qau#vj8@0f'
...
WSGI_APPLICATION = 'trydjanog.wsgi.application'
